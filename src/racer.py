...
# One way to retrieve UDP link is to have a while loop that checks if sendFeed is empty until UDP link is received
# from RM.
...
class RaceConnection:
    ...
    # Retrieve which UDP link to stream to, store it in sendFeed. msg is the racer number given to you (connection 1
    # or 2)
